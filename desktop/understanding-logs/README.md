...
### Gateway log
The **gw.log** file logs the activities of the message bus of io.Connect Desktop. In the current version, it is written in **Node.js** (was written in Closure in the past).
